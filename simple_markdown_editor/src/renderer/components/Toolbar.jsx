...
const TOOLS = [
  ...
  { action: 'strikethrough', label: 'Strikethrough', shortcut: '⌘⇧X', icon: 'S', className: 'tool-strike' },
  { type: 'separator' },
  { action: 'h1', label: 'Heading 1', icon: 'H1' },
  { action: 'h2', label: 'Heading 2', icon: 'H2' },
  { action: 'h3', label: 'Heading 3', icon: 'H3' },
  { type: 'separator' },
  { action: 'ul', label: 'Bullet List', shortcut: '⌘⇧L', icon: 'list-ul' },
  { action: 'ol', label: 'Numbered List', shortcut: '⌘⇧O', icon: 'list-ol' },
  { action: 'quote', label: 'Quote', shortcut: '⌘⇧.', icon: 'quote' },
  { type: 'separator' },
  { action: 'code', label: 'Inline Code', shortcut: '⌘E', icon: 'code' },
  { action: 'codeblock', label: 'Code Block', shortcut: '⌘⇧C', icon: 'codeblock' },
  { type: 'separator' },
