...
v0.1.7 is feature-complete but currently untested and unreviewed. Incremental code review and testing will be completed before work on v0.2.0 begins. See [ROADMAP.md](ROADMAP.md) for what's planned.
